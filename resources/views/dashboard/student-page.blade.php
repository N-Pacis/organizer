                ...
                @for($i=0;$i < count($students_list);$i++)
                    <tr>
                        <td class="px-5 py-5 border-b border-gray-200 bg-white">
                            <img src="profile-pictures/{{$students_list[$i]->picture}}" alt="Nkubito Pacis" class="w-10 h-10 flex-shrink-0 rounded-full profile-picture">
                        </td>
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">{{$students_list[$i]->student_id}}</p>
                        </td>                        
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">{{$students_list[$i]->firstname}}</p>
                        </td>
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">{{$students_list[$i]->lastname}}</p>
                        </td>
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">{{$students_list[$i]->phone_number ? $students_list[$i]->phone_number: 'Not Available'}}</p>
                        </td>
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">{{$students_list[$i]->address ? $students_list[$i]->address : 'Not Available'}}</p>
                        </td>
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">{{$students_list[$i]->enrolled_in}}</p>
                        </td>
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">{{$students_list[$i]->status}}</p>
                        </td>
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <button class="action-btn rounded-md px-4 py-2 text-white font-semibold" title="Take Action On this Student" id="action-btn" onclick="openModal('student-modal');{{ session()->has('current_user') ? null:session()->put('current_user',$students_list[$i])}}">View</button>
                        </td>
                    </tr> 
                @endfor
